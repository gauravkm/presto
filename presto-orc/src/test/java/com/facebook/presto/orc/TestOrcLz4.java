...
public class TestOrcLz4
{
            ...
            throws Exception
    {
        ...
        OrcReader orcReader = new OrcReader(new InMemoryOrcDataSource(data), ORC, new StorageOrcFileTailSource(), new StorageStripeMetadataSource(), new OrcReaderOptions(
                SIZE,
                SIZE,
                SIZE,
                false));
